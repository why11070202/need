  ...
  <div class="street-wrap common-width">
    ...
    <div class="next-content-wrap">
      <v-table
        ...
        clickHeade
        :tHeader="tHead"
        :clickHeaderNumber="clickHeaderNumber"
        :tBody="tBody"
        :tFoot="tFoot"
        @headClick="_headClick"/>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      _headClick() {
        ...
        path = path.replace(/\d{4}-\d{2}/, `${this.year}-${this.month}`);
      ...
      _getApi() {
        const _self = this;
        _self.$post('/incomecheckprogress/findSalesGroupByManager', {
