<template>
  <div class="quality-wrap common-width">
...
<script type="text/ecmascript-6">
  ...
  import {getAddQualityOrganizationApi, getAddQualityApi} from "../../../../../Fetch/port";
  ...
  export default {
            ...
            render: (h, params) => {
              return h(
                ...
                params.row.isFooter ? {
                  ...
                  on: {
                    click: () => {
                      _self._toDetail(params.row.indicatorItem);
                    }
                  }
                } : {},
    ...
    mounted() {
      const _self = this;
      getAddQualityOrganizationApi(res => {
